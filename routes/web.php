...
// Reset Password
Route::get('forget-password', 'App\Http\Controllers\Auth\ForgotPasswordController@ForgetPassword')->name('ForgetPassword');
Route::post('forget-password','App\Http\Controllers\Auth\ForgotPasswordController@ForgetPasswordStore')->name('ForgetPasswordPost');
Route::get('reset-password/{token}', 'App\Http\Controllers\Auth\ForgotPasswordController@ResetPassword')->name('ResetPasswordGet');
Route::post('reset-password', 'App\Http\Controllers\Auth\ForgotPasswordController@ResetPasswordStore')->name('ResetPasswordPost');