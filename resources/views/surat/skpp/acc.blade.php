@extends('layouts.app')
@section('title', 'Terima Pengajuan SKPP')
@section('content')
<div class="card">
    <div class="card-body">
        <center class="m-t-30"> 
        ...
        <div class="d-flex flex-column">
                <a href="{{ Route('cetak.skpp', $data->id) }}" target="_blank"><b>Download / Cetak Surat</b></a>
            <div>
                <hr>
                <form method="post" action="{{ Route('skpp.acc', $data->id) }}">
                    @csrf
