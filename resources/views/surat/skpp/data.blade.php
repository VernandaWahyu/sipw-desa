        ...
        <div class="d-flex flex-column">
            <div>
                <div class="d-flex flex-column">
                    ...
                    <div class="row">
                        ...
                        <div class="text-left col-7">
                            {{ $data->tempatlahir }}, {{ date('d-m-Y', strtotime($data->tanggallahir)) }}</div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="text-right col-1">:</div>
                        <div class="text-left col-7">{{ $data->alamatasal }}</div>
                    </div>
                    <div class="row">
                        <div class="col-4">Alamat Pindah</div>
                        <div class="text-right col-1">:</div>
                        <div class="text-left col-7">{{ $data->alamat_pindah_kelurahan }},
                            {{ $data->alamat_pindah_kecamatan }}, {{ $data->alamat_pindah_kabupaten }},
                            {{ $data->alamat_pindah_provinsi }}</div>
                    </div>
                    {{-- <div class="row">
                ...
                <div class="mb-3 d-flex justify-content-between">
                    <a href="{{ Route('skpp.acc',$data->id) }}" class="btn btn-primary">Terima Pengajuan</a>
                    <form action="{{ Route('skpp.nacc', $data->id) }}" method="post">
                        @csrf
...
{{-- <script>
    let tanggal = {{date('M',$this->tanggallahir)}};
    console.log(tanggal);
</script> --}}
@endsection