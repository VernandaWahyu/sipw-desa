...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            <form class="w-100 me-3" method="POST" action="{{ Route('surat.skd') }}">
                @csrf
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $item->status }}</td>
                        <td class="d-flex">
                            <a class="mx-2" href="{{ Route('skd.show', $item->id) }}">
                            ...
                            <a href="{{ Route('skd.acc', $item->id) }}" class="mx-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="25" fill="none" viewBox="0 0 24 24"
                                    stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M5 13l4 4L19 7" />
                            ...
                            <form action="{{ Route('skd.nacc', $item->id) }}" method="post">
                                @csrf
