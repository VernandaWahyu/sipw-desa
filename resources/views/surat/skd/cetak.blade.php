...
$pdf->Cell(0,5,'PEMERINTAH KABUPATEN PONOROGO',$border,1,'C');
$pdf->Cell(0,5,'KECAMATAN MLARAK',$border,1,'C');
$pdf->SetFont('Arial','B',13);
$pdf->Cell(0,5,'DESA MLARAK',$border,1,'C');
$pdf->SetFont('Arial','B',9);
$pdf->Cell(0,4,'Jl Mlarak Pulung N0.39, - Purworejo, Kode Pos 63472',$border,1,'C');
$pdf->Cell(0,4,'Email : pemerintahdesamlarak@gmail.com, Ig @pemdes_mlarak',$border,1,'C');
$pdf->Cell(0,4,'Website: https://mlarak.ponorogokab.go.id/desa/mlarak',0,1,'C');
$pdf->Cell(0,1,'',0,1,'C');
...
$pdf->Cell(0,10,'',0,1,'C');
$pdf->MultiCell(0,5, "     Dengan ini Kepala Desa Mlarak Kecamatan Mlarak Kabupaten Ponorogo, menerangkan yang sebenarnya bahwa : ");
$pdf->Cell(0,5,'',0,5,'C');
...
$tabel->endTable();
$pdf->SetFont('Arial','',11);
$pdf->MultiCell(0,5, "     Berdasarkan Permohonannya serta catatan kependudukan yang ada di kantor kami, nama tersebut Bertugas selaku (".$id->pekerjaan.") yang Berdomisili Desa Mlarak Kecamatan Mlarak Kabupaten Ponorogo.");
...
$tabel->easyCell('');
$tabel->easyCell(""); 
$tabel->easyCell('Mlarak, ' . date("d M Y"));
$tabel->printRow();
$tabel->easyCell('Pemohon');
$tabel->easyCell(""); 
$tabel->easyCell('KEPALA DESA MLARAK'); 
$tabel->printRow();
$pdf->Cell(0,20,'',0,5,'C');
