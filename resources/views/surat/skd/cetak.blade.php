...
$tabel->endTable();
$pdf->SetFont('Arial','',11);
$pdf->MultiCell(0,5, "     Berdasarkan Permohonannya serta catatan kependudukan yang ada di kantor kami, nama tersebut Bertugas selaku (".$id->pekerjaan.") yang Berdomisili Desa mlarak Kecamatan Gondang Kabupaten Nganjuk.");
